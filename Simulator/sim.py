...
y = {'right': [348, 370, 398], 'down': [0, 0, 0], 'left': [498, 466, 436], 'up': [600, 600, 600]}  # Adjusted y coordinates
...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction):
        ...
        self.y = y[direction][lane]  # Adjusted y coordinates
        self.crossed = 0
        vehicles[direction][lane].append(self)
        self.index = len(vehicles[direction][lane]) - 1
        path = "E:/Code/minipro/Simulator/resources/" + direction + "/" + vehicleClass + ".png"
        ...
        if direction == 'right':
            ...
            y[direction][lane] -= temp  # Might need further adjustment based on the image size
        elif direction == 'up':
            temp = self.image.get_rect().height + stoppingGap
...
class Main:
    ...
    background = pygame.image.load(r"E:/Code/minipro/Simulator/resources/intersection.png")
    background = pygame.transform.scale(background, screenSize)  # Scale to match window size
    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")
    redSignal = pygame.image.load(r"E:/Code/minipro/Simulator/resources/signals/red.png")
    yellowSignal = pygame.image.load(r"E:/Code/minipro/Simulator/resources/signals/yellow.png")
    greenSignal = pygame.image.load(r"E:/Code/minipro/Simulator/resources/signals/green.png")
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
        screen.blit(background, (0, 0))  # Blit at the top-left corner of the screen
        for i in range(0, noOfSignals):
            if i == currentGreen:
                if currentYellow == 1:
