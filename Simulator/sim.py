...
def generateVehicles():
    while True:
        try:
            ...
            print("Error in generateVehicles:", e)
        time.sleep(0.75)
...
class Main:
    ...
    background = pygame.image.load('E:/Code/minipro/Simulator/resources/intersection1.jpg')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load('E:/Code/minipro/Simulator/resources/signals/red.png')
    yellowSignal = pygame.image.load('E:/Code/minipro/Simulator/resources/signals/yellow.png')
    greenSignal = pygame.image.load('E:/Code/minipro/Simulator/resources/signals/green.png')
